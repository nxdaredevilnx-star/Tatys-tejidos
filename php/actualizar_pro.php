...
<body>
  <div class="container">
    ...
    $registros = mysqli_query($conexion, 
      "select * from productos where precio ='$_REQUEST[precio]'") 
      or die("Problemas en el select:" . mysqli_error($conexion));

    if ($reg = mysqli_fetch_array($registros)) {
    ?>
      <form action="actualizar_pro3.php" method="post">
        <label>Ingrese nuevo precio:</label><br>
        <input type="text" name="precionuevo" value="<?php echo $reg['precio'] ?>"><br>
